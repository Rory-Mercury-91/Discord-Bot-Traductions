...
(function() {
    ...
    // Ajout d'un petit bouton discret en haut à droite
    const btn = document.createElement('button');
    btn.innerHTML = '📋 Copy Data';
    btn.style = "position:fixed;top:10px;right:10px;z-index:9999;padding:8px;background:#6366f1;color:white;border:none;border-radius:5px;cursor:pointer;font-weight:bold;font-size:12px;";
